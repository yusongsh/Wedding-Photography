      ...
      <section className="flex flex-col justify-center items-center mx-auto mb-16 gap-10">
        ...
        <div className="">
          <Link href="/information">
            <button className="text-sm lg:text-base font-medium uppercase px-[calc(100vw/4)] py-3 lg:px-10 lg:py-4 bg-light rounded-full text-dark whitespace-nowrap hover:bg-light/90 transition-all">
              Information
            </button>
          </Link>
        </div>
      ...
      <section className="relative lg:my-16" aria-label="featured-content">
        <div className="w-screen h-auto aspect-[3/2] max-h-[800px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
            <div className="bg-light/10 backdrop-blur-[6px] rounded-[2rem] py-6 px-4 lg:p-16 w-[95%] max-w-3xl mx-auto border border-light/20 shadow-2xl">
              <div className="text-center">
                <h2 className="text-xl lg:text-[2rem] uppercase font-medium mb-6 text-light tracking-[-0.02em] leading-[1.2]">
                  Let&apos;s RAISE A toast
                </h2>
                <p className="text-sm lg:text-lg font-light text-light/95 max-w-2xl mx-auto mb-6 lg:mb-10 leading-[1.5]">
